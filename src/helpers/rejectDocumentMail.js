...
router.rejectDocumentMail = ( data , name = null )=>{
				...
				<table style="padding: 20px;">
					<tr>
						<td>
							...
							<p style="font-size:14px;">In order to proceed further kindly, re-upload the correct document(s) on the dashboard.  </p>
							<p style="font-size:14px;">Please proceed to the dashboard and re-upload the correct document(s).</p>
						</td>
					</tr>
					<tr>
						<td style="text-align: center; padding: 10px;">
							<a href="#" style="font-size:14px;background: #00B957;border-radius: 5px;padding: 10px;color: #fff; text-decoration: none;">Upload Document(s)</a>
						</td>
					</tr>
					<tr>
						<td>
