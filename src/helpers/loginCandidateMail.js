...
router.loginCandidateMail = ( email, name, subject = null, projectName = null, designation = null , is_assessment_enabled = false )=>{
	...
	var assessment_data = '';
	if( is_assessment_enabled ){
		assessment_data = `<p style="font-size:14px;">Below is a link to a small quiz we would like you to tackle which should take no more than 20 minutes. This will help us to understand the way you work and also give us some insight into your skills. </p>
							<p style="font-size:14px;">Please proceed to the dashboard and complete the quiz. Login credential is shared to you. </p>
							`;
	}
...
<body style="font-family: 'Poppins', sans-serif; color: #585858;">
				...
				<table style="padding: 20px;">
					<tr>
						<td>
							...
							<p style="font-size:14px;">Thanks for taking the time to apply for ${designation}, ${projectName}. We appreciate your interest and we're currently in the process of going through all the applications for this position.</p>
							${assessment_data}
					...
					<tr>
						<td style="text-align: center; padding: 10px;">
							<a href="${process.env.CANDIDATE_PANEL_URL}login" style="font-size:14px;background: #00B957;border-radius: 5px;padding: 10px;color: #fff; text-decoration: none;">Go To Login Panel</a>
						</td>
					</tr>
					<tr>
						<td>
  ...
  const mailSubject = `Thanks, Your Application received for ${designation}, ${projectName}`;
