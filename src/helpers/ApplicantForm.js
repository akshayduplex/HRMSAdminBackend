...
router.ApplicantForm = ( email, name, position = null, mailRegards = null )=>{ 
...
<head>
    ...
    <title>Complete Applicant Form</title>
...
<body style="font-family: 'Poppins', sans-serif; color: #585858;">
  ...
  const mailSubject = `Dear ${name} Complete Applicant Form for ${position}!`;
