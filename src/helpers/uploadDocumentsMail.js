...
router.uploadDocumentsMail = ( email, name )=>{
...
<body style="font-family: 'Poppins', sans-serif; color: #585858;">
				...
				<table style="padding: 20px;">
					<tr>
						<td>
							...
							<p style="font-size:14px;">You are receiving this email since our recruitment team has raised concerned over the document(s) you have submitted for the hiring process.</p>
							<p style="font-size:14px;">In order to proceed further kindly, upload the correct document(s) on the dashboard.  </p>
							<p style="font-size:14px;">Please proceed to the dashboard and upload the correct document(s).</p>
						</td>
					</tr>
					<tr>
						<td style="text-align: center; padding: 10px;">
							<a href="${process.env.CANDIDATE_PANEL_URL}login" style="font-size:14px;background: #00B957;border-radius: 5px;padding: 10px;color: #fff; text-decoration: none;">Upload Document(s)</a>
						</td>
					</tr>
					<tr>
						<td>
	...
	const mailSubject = "Documents Required!";
