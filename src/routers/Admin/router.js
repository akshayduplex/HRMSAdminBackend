...
router.post('/cloneJobAppliedByCandidate', verifyToken, validatecloneJobAppliedByCandidate, asyncErrorHandler(ApplyJobController.cloneJobAppliedByCandidate));
...
router.post('/send_appointment_mail', verifyToken, sendAppointmentMailToCandidates, asyncErrorHandler(ApplyJobController.sendAppointmentMailToCandidates));
